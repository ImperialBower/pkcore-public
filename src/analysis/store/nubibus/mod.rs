...
impl Nubibus {
    ...
    pub fn from_pluribus(pluribus: &Pluribus) -> Nubibus {
        ...
        for i in 0..pluribus.players.len() {
            ...
            let default_name = format!("Player{seat_number}");
    ...
    /// `Position6Max::UTG` position.
    ///
    /// # Panics
    ///
    /// ¯\\_(ツ)_/¯
    pub fn do_blinds(&mut self) {
        self.post_small_blind();
        self.post_big_blind();
        assert_eq!(Position6Max::UTG, self.current_position());
    }
    ...
    #[must_use]
    pub fn in_play(&self) -> Vec<&Seat> {
        self.seats.iter().filter(|s| s.is_active()).collect()
    }

    pub fn in_play_print(&self) {
        println!("{}", Itertools::join(&mut self.in_play().iter(), "\n"));
    }

    #[must_use]
    pub fn is_current_seat_active(&self) -> bool {
...
impl Display for Nubibus {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let joined = Itertools::join(&mut self.seats.iter(), "\n");
        write!(f, "\n{joined}")
    }
}
...
mod store_nubibus_tests {
    ...
    #[case(
        "STATE:2:fffr200fc/cc/r875f:2h3c|Jc4c|6c9c|8c4s|Jh4h|KsAd/5c9s7c/3h:-50|250|0|0|0|-200:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo"
    )]
    #[case(
        "STATE:3:ffr200r700ffr2050c/cc/cr4175f:JhKh|JdTs|3hAc|4sTc|5hAh|9c9d/9sJc5d/8h:-50|-100|0|0|-2050|2200:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case(
        "STATE:4:ffr225r800fff:Tc2c|3c6c|5s8s|Ts2h|KcTh|TdAh:-50|-100|0|0|-225|375:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
    ...
    #[case(
        "STATE:10:fffr222r950ff:AcQh|9d9c|7d4s|8s4c|Td4h|4dAh:322|-100|0|0|0|-222:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case("STATE:11:fffr250ff:9cAd|4h7c|Ts2s|6s8c|6c8s|QhAh:-50|-100|0|0|0|150:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill")]
    #[case(
        "STATE:12:fffr225fc/cr475c/cr1475c/cc:Ks7d|8sQh|2sKh|7c5d|Jh9d|TcJc/3dQc2c/9s/5s:-50|1525|0|0|0|-1475:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus"
    )]
    #[case("STATE:13:fffff:Kh4d|8d9s|5hQd|TsKc|3h7h|Jc2d:-50|50|0|0|0|0:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite")]
    #[case("STATE:14:ffr225fff:Jc2d|2cJs|7c6s|5hAs|KhAd|Qs9c:-50|-100|0|0|150|0:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo")]
    #[case("STATE:15:fr225ffff:3h7h|9s3c|9h5d|JsQd|7sTh|Kc8h:-50|-100|0|150|0|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd")]
    #[case(
        "STATE:16:fr200fccc/cccc/ccr700ffr1600r3550r7300f:4c4s|7dTd|Qh2d|6s7s|Qd8s|3h3s/5hTs8h/Tc:-200|3950|0|-3550|0|-200:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
        "STATE:17:r200ffffc/cr350c/cc/r1100f:Tc3c|6dQs|4c4h|6c2c|As7d|2sKc/2d9c6h/Qd/5h:-50|400|-350|0|0|0:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    #[case("STATE:18:fffff:Ts6d|3sKc|6hAd|Kd6c|5d4h|3h6s:-50|50|0|0|0|0:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus")]
    #[case("STATE:19:fr225ffff:Jc6s|Qh7c|4dQs|8s8h|5d7h|Qd3d:-50|-100|0|150|0|0:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite")]
    #[case("STATE:20:r225fffff:3h6h|Ah6c|KsKh|9hQc|Jd4s|3d8s:-50|-100|150|0|0|0:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo")]
    #[case(
        "STATE:21:r250fr800fffc/cr1400c/cc/cc:7s4h|Qc3s|9c9s|8h2d|KdQs|8d3c/9hTsJh/Kh/Ah:-50|-100|-1400|0|1550|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case(
        "STATE:22:fr200ffr850fc/cc/r2200c/r5575f:KcKs|4h2s|Ah2d|9h8h|4cKh|8sJh/QsTc8d/7h/7s:2300|-100|0|-2200|0|0:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
        "STATE:23:ffr200ccr1150ccf/cr2063ff:6cAc|AsKs|Th2d|5c4s|8s8d|6s6h/7dTd8c:-200|-1150|0|0|2500|-1150:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    #[case("STATE:24:fffr250ff:Th3c|Js2c|As8c|7h4s|Kd9c|6d4d:-50|-100|0|0|0|150:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus")]
    #[case("STATE:25:fffr225ff:7h4d|9s6h|2c9h|As7d|6sTc|Ad5s:-50|-100|0|0|0|150:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite")]
    #[case("STATE:26:fffff:6s5d|6dAd|Jd4d|5h9c|Td2c|3h4c:-50|50|0|0|0|0:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo")]
    #[case(
        "STATE:27:r200ffcfc/cr850cf/cr1825r3775c/r10000c:Qc4h|Tc9c|8sAs|Qh7c|JcQd|5h5d/3h7s5c/Qs/6c:-50|-200|-10000|0|0|10250:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case("STATE:28:ffffr300f:TdTh|4s9c|Tc7c|7s8c|Js2s|8h2c:100|-100|0|0|0|0:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie")]
    #[case(
        "STATE:29:fr225cfff/cr705f:2cTd|5d3c|5hAd|3h3s|AcTc|4h9h/JsKc2h:-50|-100|0|-225|375|0:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    #[case("STATE:30:ffr225fff:8sQd|5s3c|3s7h|Td8c|JdAs|2dTs:-50|-100|0|0|150|0:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus")]
    #[case(
        "STATE:31:r200ffffc/cr335r725c/cc/r2225f:Js4h|7h5h|TcTd|6c4c|Kc6s|Kh6h/5s2sQh/2d/5c:-50|775|-725|0|0|0:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite"
    )]
    #[case(
        "STATE:32:fffr200r900fc/r1600f:KcJh|5d3c|8c2h|8d3d|6sTs|TdQc/2s9d5c:1000|-100|0|0|0|-900:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo"
    )]
    #[case(
        "STATE:33:fr225fffc/cr600r1350c/cr2349f:7h9c|Jh9h|5cJd|KhQd|5dTh|4s8s/TsKd3h/4c:-50|-1350|0|1400|0|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case(
        "STATE:34:fffr222r950ff:6hAh|8c7s|4cQc|7hAs|Jd2d|9cAd:322|-100|0|0|0|-222:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
    ...
    #[case(
        "STATE:36:r225fr700fffc/cr1225c/cr3175f:6s3d|2h5h|9h9d|Th8h|AsQh|TdKc/6d5sQs/Jd:-50|-100|-1225|0|1375|0:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus"
    )]
    #[case(
        "STATE:37:r200ffcfr1350fc/cc/cc/cc:3h2s|AsKc|AcJd|KdQh|JcTs|7h7d/Jh2d4h/Qd/6c:-50|-1350|-200|0|0|1600:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite"
    )]
    #[case(
    ...
    #[case(
        "STATE:41:fffr250cc/r1000ff:ThTs|7s7h|9c6c|3s5c|8s4c|QcKd/4h9s6h:500|-250|0|0|0|-250:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    ...
    #[case(
        "STATE:45:ffffcc/cr250c/cr625f:As6c|9c4c|3c5h|6h2s|Ks7c|3s9s/5c8sTs/Qc:-250|250|0|0|0|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case(
        "STATE:46:ffffr300r1200f:Kc3c|8s7s|Ts5d|4d7d|6d3s|Qc5h:-300|300|0|0|0|0:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
        "STATE:47:fffr250fc/cr525c/cc/cc:6d5s|Td2d|4dKh|7c4c|3s6c|7d8c/6sAsTh/7s/Ts:-50|575|0|0|0|-525:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    ...
    #[case(
        "STATE:50:r225fffcf/cr400c/cc/cc:8c8h|Jh5s|4h5h|6s5d|6h2c|QhTs/Ah4c2d/Qd/8s:500|-100|-400|0|0|0:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo"
    )]
    #[case(
        "STATE:51:fr225cfr1250ffc/r1956f:AdTd|Kd9s|TcJs|3s3d|7d7h|8sJh/8hAh8d:1575|-100|0|-225|-1250|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case(
        "STATE:52:fr200fffr1100c/r2225c/cc/r5600f:8h3c|7d6d|5dTd|7c7s|Ah4c|Ts9d/3s6c8c/Ad/8s:-50|2275|0|-2225|0|0:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
        "STATE:53:fr225fffc/cc/cr475f:6h8s|2dAs|Kc6c|Qc9c|3sTc|3cQs/2h8dQd/9h:-50|-225|0|275|0|0:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    #[case(
        "STATE:54:fr200fffc/cr300c/cc/r950f:Jd8c|4h4s|Jh2s|KsQs|9cQh|As6h/7dAcAd/9h/9d:-50|350|0|-300|0|0:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus"
    )]
    #[case("STATE:55:fffff:Qd7c|8dQc|Jc8h|7dJh|Kc9s|7sQh:-50|50|0|0|0|0:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite")]
    #[case(
        "STATE:56:ffffr300c/r750f:Ks8d|4s2s|2hQd|Jd4c|3h2d|9d6s/KdQsTc:300|-300|0|0|0|0:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo"
    )]
    #[case("STATE:57:ffr200fff:5hAc|5d4h|Ts2s|6s8c|8s9d|6c2d:-50|-100|0|0|150|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd")]
    #[case(
        "STATE:58:fffr222r950ff:KhTh|5s6h|7h5h|2cQd|6d2d|As9c:322|-100|0|0|0|-222:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
        "STATE:59:r200fffcc/ccr500ff:9hAh|3hKc|AdAc|7c8d|3s7h|2sJd/3dJh5d:-200|-200|400|0|0|0:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    #[case(
        "STATE:60:ffr225fr775fc/cr1600f:Ad9d|Tc7c|8cQh|8s5s|Ac6c|3s4c/2cKdJh:-775|-100|0|0|875|0:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus"
    )]
    #[case(
        "STATE:61:fr225fcr1400fff:As7s|2h7d|Kd5s|Ad5d|5h3c|Ah9h:550|-100|0|-225|0|-225:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite"
    )]
    #[case(
        "STATE:62:fffr200fr1250f:QsTh|JdJc|5dKh|Ad8s|Tc2h|8cQh:-50|250|0|0|0|-200:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo"
    )]
    #[case(
        "STATE:63:ffffcc/r200c/r520f:Th7s|7dKc|Ad9h|5dQs|8h3h|Ts4c/2dAs6c/8d:200|-200|0|0|0|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case("STATE:64:ffr225fff:JcTh|4cKs|7h4d|Kd9h|TsQd|7s5s:-50|-100|0|0|150|0:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie")]
    #[case(
        "STATE:65:fr225fffc/cr400f:5cQh|Ks7c|8s3c|AdTd|6hKc|QsTc/4s2c3s:-50|-225|0|275|0|0:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    #[case(
        "STATE:66:r225ffffc/cr400r900c/cr1500r3400f:2c3c|9sTc|KdKs|5d7d|4sJs|5sAc/7cThTs/7s:-50|1550|-1500|0|0|0:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus"
    )]
    #[case(
        "STATE:67:r200ffffc/cr605f:5s9s|6sAh|3h3s|9c5d|9hKs|3d5c/7cJsKc:-50|-200|250|0|0|0:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite"
    )]
    #[case("STATE:68:fffff:7d5c|Th8s|Ts9c|Kh4h|6s3h|4sJh:-50|50|0|0|0|0:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo")]
    #[case(
        "STATE:69:ffffcc/cc/cr200c/cr500f:TdJc|2s7s|Kd9s|Jh5s|7d3h|Js5c/6s8sAc/6d/As:-200|200|0|0|0|0:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd"
    )]
    #[case(
        "STATE:70:r225ffr800fff:Qh5d|5c6c|7d7s|8s6d|6hJh|KcAc:-50|-100|-225|0|0|375:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie"
    )]
    #[case(
        "STATE:71:fr225fffc/cr400f:8dQd|Tc3c|2s9c|Kh9h|3h8h|6dJc/3d4dKd:-50|-225|0|275|0|0:Pluribus|MrWhite|Gogo|Budd|Eddie|Bill"
    )]
    #[case(
        "STATE:72:fffr200fc/cc/cr312c/cr649f:3c5h|4cKh|Kd3d|Jd4h|4d8s|5c8c/QsAdQh/6c/9d:-50|-312|0|0|0|362:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus"
    )]
    #[case("STATE:73:r200fffff:Kh3h|3c2s|Kd9d|Qs4s|4hJs|8cAs:-50|-100|150|0|0|0:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite")]
    #[case(
        "STATE:74:ffr225ffc/cc/r850c/r2600f:6s7s|As8s|Ad9c|4sKh|KsQs|2c6c/Ac9sKc/6h/5s:-50|900|0|0|-850|0:Budd|Eddie|Bill|Pluribus|MrWhite|Gogo"
    )]
    #[case("STATE:75:fffr250ff:6dTs|5c3s|Ad4h|ThKs|Jh2d|AhAc:-50|-100|0|0|0|150:Eddie|Bill|Pluribus|MrWhite|Gogo|Budd")]
    #[case("STATE:76:fffff:3s7h|6hJc|JdTh|3d9c|5dQh|4h3h:-50|50|0|0|0|0:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie")]
    #[case(
    ...
    #[case("STATE:78:fffr200ff:8hTc|9d2c|6cQd|Js7d|7cKh|QsAs:-50|-100|0|0|0|150:MrWhite|Gogo|Budd|Eddie|Bill|Pluribus")]
    #[case(
        "STATE:79:fffr225r900fc/r1900f:5s3s|TcKc|Qh9s|Ah7d|9c6s|QcKs/4dJc8h:1000|-100|0|0|0|-900:Gogo|Budd|Eddie|Bill|Pluribus|MrWhite"
    )]
    //endregion
    fn from_pluribus(#[case] row: &str) {
    ...
    const ROW_52: &str = "STATE:52:fr200fffr1100c/r2225c/cc/r5600f:8h3c|7d6d|5dTd|7c7s|Ah4c|Ts9d/3s6c8c/Ad/8s:-50|2275|0|-2225|0|0:Bill|Pluribus|MrWhite|Gogo|Budd|Eddie";

    fn parse_row_52() -> Nubibus {
        let plur = Pluribus::from_str(ROW_52);
        Nubibus::from_pluribus(&plur.as_ref().unwrap())
    }

    #[test]
    fn from_pluribus_single() {
        let plur = Pluribus::from_str(ROW_52);

        let mut nub = parse_row_52();
        nub.do_init();
        nub.play_preflop(); // f r200 f f f r1100 c

        assert!(plur.is_ok());
        println!("{}", nub);
    }

    /// Here's the test generated by GitHub copilot:
    ///
    /// ```txt
    /// let mut nubibus = parse_row_52();
    /// nubibus.do_init();
    ///
    /// assert_eq!(Position6Max::BTN, nubibus.current_position());
    /// ```
    #[test]
    fn current_position() {
        let mut nubibus = parse_row_52();
    ...
    fn get_next_active_seat() {
        ...
        // assert_eq!(Position6Max::UTG, nubibus.get_next_active_seat().unwrap());
    }

    #[test]
    fn in_play() {
        let nubibus = parse_row_52();
        nubibus.seat_from_position(Position6Max::UTG).fold();

        assert_eq!(5, nubibus.in_play().len());
        nubibus.in_play_print();
    }

    #[test]
    fn next_active_position() {
        let mut nubibus = parse_row_52();
        nubibus.do_init();
    }
    ...
    fn seat_from_position() {
        ...
        assert!(!nubibus.seat_from_position(Position6Max::UTG).is_active());
        assert!(nubibus.seat_from_position(Position6Max::BTN).is_active());
    }
